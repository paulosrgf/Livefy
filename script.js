...
// The queue is set by home.js before navigating here. If the player is
// opened directly, fall back to the full "Playlist Essentials" queue.
const storedQueue = JSON.parse(localStorage.getItem("livefy-queue") ?? "null");
const originalPlaylist = storedQueue ?? window.LivefyData.getAllSongsFlat();
...
function toHHMMSS(originalNumber) {
  if (Number.isNaN(originalNumber)) return "00:00";
